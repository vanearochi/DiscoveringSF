...
/** Creates TravelMode Classes
  * @param {String} mode - Travel mode displayed on the page.
  * @param {String} directionsStr - Travel Mode used on showDirections function
*/
	...
	askInfoToPlacesLibrary = function(marker){
		...
		function placeInformation(data, status){
			...
			if (status == google.maps.places.PlacesServiceStatus.OK) {
				...
				alert('Sorry there was an error.Please see the Javascript console for technical details' + status);
			}
		}
	};
